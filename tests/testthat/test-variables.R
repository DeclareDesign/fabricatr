...
test_that("Categorical invalid tests", {
  expect_error(draw_categorical(prob=c(-1, 0, -0.5),
...
test_that("Categorical valid tests", {
  draw_categorical(prob=matrix(rep(c(0.3, 0.3, 0.4), 3),
...
test_that("Binary ICCs", {
  ...
  # X isn't a vector
  expect_error(draw_binary_icc(prob = data.frame(j = c(0.1, 0.2),
                                              k = c(0.2, 0.4),
                                              m = c(0.3, 0.6),
                                              o = c(0.4, 0.8),
                                              p = c(0.5, 1.0)),
...
test_that("Normal ICC", {
  ...
  # X isn't a vector
  expect_error(draw_normal_icc(mean = data.frame(j = c(0.1, 0.2),
                                              k = c(0.2, 0.4),
                                              m = c(0.3, 0.6),
                                              o = c(0.4, 0.8),
                                              p = c(0.5, 1.0)),
