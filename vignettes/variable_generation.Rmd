...
respondents <- fabricate(
  ...
  economic_conservative = correlate(draw_binomial, 
                                    prob = 0.6, 
                                    trials = 20,
                                    given = conservative_values,
                                    rho = 0.5),
  foreign_policy = correlate(draw_binomial,
                            prob = 0.4,
                            trials = 20,
                            given = conservative_values,
                            rho = 0.3)
...
student_report_card <- fabricate(
  ...
  chemistry_score = correlate(rnorm, mean = 75, sd = 5, 
                              given = math_score, rho = 0.8),
  civics_score = correlate(rnorm, mean = 85, sd = 5,
                           given = math_score, rho = 0.6)
)
```
