...
survey_data = fabricate(N = 100,
                        ...
                        Q4 = draw_likert(x = rnorm(N), 
                                         breaks = c(-Inf, -0.8, 0, 1, 2, Inf))
)
...
[`draw_count()`](../reference/draw_count.html) allows you to create Poisson-distributed count outcomes. These require that the user specify the parameter `mean`, equal to the Poisson distribution mean (often referred to as `lambda` in statistical formulations of count data).
