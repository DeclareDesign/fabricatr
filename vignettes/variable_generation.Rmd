...
[`draw_count()`](../reference/draw_count.html) allows you to create Poisson-distributed count outcomes. These require that the user specify the parameter `means`, equal to the Poisson distribution mean (often referred to as `lambda` in R's built-in functions or other statistical formulations).
