...
relationship_matrix = matrix(c(0, 0, "",
                               0, 0, "",
...
2. Use the `cross_level()` function to join the non-nested data frames to make a panel.
...
2. Use the `cross_level()` function to join the non-nested data frames on *particular variables*, optionally specifying a desired correlation outcome.
...
three_data <- fabricate(
  ...
  students = cross_level(N = 1500, 
                         by = join(ps_quality, ss_quality, c_quality,
                                   rho = 0.2),
