...
Again, we see the use of `draw_binary()`. Using this function is covered in our tutorial on [generating discrete random variables](http://declaredesign.org/R/fabricatr/articles/variable_generation.html), linked below.
...
You've seen **fabricatr**'s ability to generate single-level and hierarchical data, which is enough to get you started on using the package. From here, you can explore more about modeling the structure of data by reading our [tutorial on panel and cross-classified data](http://declaredesign.org/R/fabricatr/articles/cross_classified.html) or [using **fabricatr** to bootstrap or resample hierarchical data](http://declaredesign.org/R/fabricatr/articles/resampling.html). Or, if you would like to learn about modeling specific variables using **fabricatr**, you can read our tutorial on [common social science variables](http://declaredesign.org/R/fabricatr/articles/common_social.html); our technical manual on [generating discrete random variables](http://declaredesign.org/R/fabricatr/articles/variable_generation.html); or our guide on [using other data generation packages](http://declaredesign.org/R/fabricatr/articles/other_packages.html) with **fabricatr**.
