...
Finally, if you are in interested in learning about how to structure your data (for example, to generate multi-level, panel, or cross-classified data), you can consult our tutorials on [building data in **fabricatr**](/R/fabricatr/articles/building_importing.html), and [panel and cross-classified data in **fabricatr*](http://fabricate.declaredesign.org/articles/cross_classified.html).
