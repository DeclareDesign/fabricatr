...
Below, we begin a series of examples discussing the creation of time series style data in **fabricatr**. This document assumes you are familiar with the basics of [building and importing data with **fabricatr**](http://declaredesign.org/R/fabricatr/articles/building_importing.html).
...
Although **fabricatr** does not have formal functionality for the creation of ARIMA time series, we recommend that interested users see our [guide to using other data creation packages with **fabricatr**](http://declaredesign.org/R/fabricatr/articles/other_packages.html), which includes an example of using the **forecast** package to generate ARIMA data.

## What's next?

You may also be interested in our online tutorial on [structuring panel and cross-classified data.](http://declaredesign.org/R/fabricatr/articles/cross_classified.html).
