...
If you'd like to read more about using **fabricatr** to model the variables you plan to collect in your experiment, see our guide on [common social science variables](), our technical manual on [generating variables with **fabricatr**](http://fabricatr.declaredesign.org/articles/variable_generation.html), or our tutorials on [resampling data](http://fabricatr.declaredesign.org/articles/resampling.html) [integrating other data-generating packages into a **fabricatr** workflow.](http://fabricatr.declaredesign.org/articles/other_packages.html).
