---
title: "Getting Started with fabricatr: Imagining Your Data Before You Collect It"
author: "Aaron Rudkin"
...
new_country_data <-
  fabricate(
    data = country_data,
    countries = level(average_temperature = runif(N, 30, 80))
  )
...
new_citizen_data <-
  fabricate(
    ...
    citizens = level(college_degree = draw_discrete(N, x=0.4 - (0.3*conflict_zone), type="binary"))
  )
```                        
...
Again, we see the use of `draw_discrete`. Using this function is covered in our tutorial on [generating discrete random variables](variable_generation.html), linked below.
