...
If you'd like to read more about using **fabricatr** to model the variables you plan to collect in your experiment, see our guide on [common social science variables](http://declaredesign.org/R/fabricatr/articles/common_social.html), our technical manual on [generating variables with **fabricatr**](http://declaredesign.org/R/fabricatr/articles/variable_generation.html), or our tutorials on [resampling data](http://declaredesign.org/R/fabricatr/articles/resampling.html) or [integrating other data-generating packages into a **fabricatr** workflow.](http://declaredesign.org/R/fabricatr/articles/other_packages.html).
...
If you'd like to read more about using **fabricatr** to structure your data, see our guides on [building and importing datasets](http://declaredesign.org/R/fabricatr/articles/building_importing.html) in **fabricatr**, [generating cross-classified and panel  data](http://declaredesign.org/R/fabricatr/articles/cross_classified.html), or [resampling data](http://declaredesign.org/R/fabricatr/articles/resampling.html) with **fabricatr**.

## DeclareDesign

**fabricatr** is one of four packages that make up the DeclareDesign software suite. Along with **fabricatr**, which helps you imagine your data before you collect it, we offer [**estimatr**](http://declaredesign.org/R/estimatr/), fast estimators for social scientists, [**randomizr**](http://declaredesign.org/R/randomizr/), an easy to use tools for common forms of random assignment and sampling, and [**DeclareDesign**](http://declaredesign.org/R/DeclareDesign/), a package for declaring and diagnosing research designs to understand and improve them.
